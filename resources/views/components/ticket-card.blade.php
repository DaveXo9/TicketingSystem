...
<div class="my-4">
  <div class="max-w-2xl px-8 py-4 mx-auto bg-gray-50 rounded-lg shadow-md dark:bg-gray-100" style="cursor: auto;">
    ...
    <div class="mt-2">
      <a href="/tickets/{{$ticket->id}}" class="text-2xl font-bold text-black dark:text-black hover:text-gray-600 dark:hover:text-gray-200 hover:underline">{{$ticket->title}}</a> 
    ...
    <div class="flex items-center justify-between mt-4">
      <a href="/tickets/{{$ticket->id}}" class="text-blue-600 dark:text-blue-400 hover:underline">Read more ⟶</a> 
